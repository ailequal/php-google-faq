...
<?php
	...
	$db = [
		'question_answer_1' => [
			...
			'paragraph_1' => 'The recent <a href="#">ruling by the Court of Justice of the European Union</a> has profound consequences for search engines in Europe. The court found that certain users have the right to ask search engines like Google to remove results for queries that include the person\'s name. To qualify, the results shown would need to be inadequate, irrelevant, no longer relevant, or excessive.',
		...
		'question_answer_2' => [
			...
			'paragraph_3' => 'You can learn more about safety and security online, including how to protect yourself and your family online, at the <a href="#">Google Safety Center</a>.',
			'paragraph_4' => '<a href="#">Learn more</a> about how we keep your personal information private and safe — and put you in control.'
		],
		'question_answer_3' => [
